...
@app.route('/about')
def about():
    return "Below link to contact to a layout template.\n http://127.0.0.1:5000/layout_template"


@app.route('/layout_template')
def layout_template():
    return "You can type things to search and get an answer in search page."
...
def results():
    ...
    page, page_title = get_page(search_term)
    return render_template("results.html", title=page_title, page=page)
